          ...
          <ul className="topbar-menu flex align-items-center">
            <li>
              <DoNavLink to="/" activeClass='active'>
                <HouseDoor strokeWidth={0.1} size={28} />
                <span>Accueil</span>
              </DoNavLink>
            </li>
            <li>
              <DoNavLink to="/investissements" activeClass='active'>
                <Buildings strokeWidth={0.1} size={28} />
                <span>Fonds</span>
              </DoNavLink>
            </li>
            <li>
              <DoNavLink to="/emplois" activeClass='active'>
                <Briefcase strokeWidth={0.1} size={28} />
                <span>Emplois</span>
              </DoNavLink>
            </li>
            <li>
              <DoNavLink to="/explorer" activeClass='active'>
                <GlobeEuropeAfrica strokeWidth={0.1} size={28} />
                <span>Explorer</span>
              </DoNavLink>
            </li>
            <li>
              <DoNavLink to="/video" activeClass='active'>
                <PersonVideo2 strokeWidth={0.1} size={28} />
                <span>Regarder</span>
              </DoNavLink>
            </li>
          </ul>
