                ...
                <div className="profile-user flex  gap-20">
                  <Avatar
                    ...
                    src={
                      user.activeProfilePicture
                        ? user.activeProfilePicture.fileUrl
                        : null
                    }
                    user={user}
                  />
                  <div className="flex flex-grow-1 flex-wrap gap-10 justify-content-between">
                    <div className="info">
                      ...
                      <small className="purple-txt">{user.email}</small>
                      <br />
                      <span className="job">
                        {user.job
                          ? user.job
                          : currentUser?.id == user?.id && (
                              <span className="add-job flex align-items-center gap-5 pointer">
                                Ajouter un metier <Pencil />
                              </span>
                            )}
                      </span>
                    </div>
                      ...
                      {existContactData?.length > 0 ? (
                        existContactData[0].status === "en attente" ? (
                          existContactData[0].receiver.id === currentUser.id ? (
                            ...
                            existContactData[0].requester.id ===
                              currentUser.id && (
                              <button className="btn btn-transparent">
                                Annuler le contact
                              </button>
                          ...
                          existContactData[0].status === "accepté" && (
                            <button className="btn btn-transparent">
                              Couper le contact
                            </button>
                          )
